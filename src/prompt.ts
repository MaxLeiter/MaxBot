...
- Infer obvious intent from the surrounding conversation and recent channel context instead of acting overly literal. Ask only when the ambiguity would materially change the action you take.
